...
class NoteSplash extends FlxSprite
{
	...
	function loadSplash(ui:String):Void
	{
		...
		{
			case 'funkin-pixel':
				loadGraphic(Paths.content.imageGraphic('gameplay/play/ui/funkin-pixel/Splashes'), true, 48, 48);
			...
			default:
				frames = Paths.content.sparrowAtlas('gameplay/play/ui/funkin/Splashes');
