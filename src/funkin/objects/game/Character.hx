...
class Character extends FlxSprite
{
	...
	@:deprecated('Hardcoded Anims will soon be replaced for Character JSONs.')
	function quickAnimAdd(name:String, prefix:String)
	{
		animation.addByPrefix(name, prefix, 24, false);
	}

	@:deprecated('Offset files will soon be replaced for Character JSONs.')
	function loadOffsetFile(offsetCharacter:String)
	{
