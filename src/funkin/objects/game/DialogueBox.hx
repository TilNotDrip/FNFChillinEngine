	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		switch (PlayState.SONG.song.formatToPath())
		{
			...
			case 'thorns':
				...
				var face:FlxSprite = new FlxSprite(320, 170).loadGraphic(Paths.content.imageGraphic('weeb/spiritFaceForward'));
		...
		handSelect = new FlxSprite(1042, 590).loadGraphic(Paths.content.imageGraphic('pixelui/hand_textbox'));
