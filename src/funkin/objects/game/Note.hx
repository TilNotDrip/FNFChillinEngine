	...
	public function new(strumTime:Float, noteData:Int, ui:String = 'funkin', ?prevNote:Note, ?sustainNote:Bool = false)
	{
		...
		switch (ui)
		{
			case 'funkin-pixel':
				if (isSustainNote)
				{
					loadGraphic(Paths.content.imageGraphic('gameplay/play/ui/funkin-pixel/NotesENDS'), true, 7, 6);
				...
				{
					loadGraphic(Paths.content.imageGraphic('gameplay/play/ui/funkin-pixel/Notes'), true, 17, 17);
			...
			default:
				frames = Paths.content.sparrowAtlas('gameplay/play/ui/funkin/Notes');
