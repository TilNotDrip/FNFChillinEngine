...
class CreditsState extends MusicBeatState
{
	...
	var peopleArray:Array<Alphabet> = [];
	var iconArray:Array<FlxSprite> = [];

	var peopleLikeJson:Array<String> = ['dot-json1969'];
	...
	override public function create()
	{
		...
		contribList.push({
			login: '.json',
			avatar_url: 'https://cdn.discordapp.com/avatars/1115022846041804820/dfbe6fa28b9cccdca31c17edd931cfc5?size=1024',
