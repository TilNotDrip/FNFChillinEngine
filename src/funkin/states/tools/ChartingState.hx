...
class ChartingState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		var actualGridBG:FlxBackdrop = new FlxBackdrop(FlxGridOverlay.createGrid(GRID_SIZE, GRID_SIZE, GRID_SIZE * 9, GRID_SIZE * 2, true, 0xffe7e6e6,
			0xffd9d5d5), Y);
	...
	function addSongUI():Void
	{
		...
		var player2DropDown = new FlxUIDropDownMenu(140, loadAutosaveBtn.y + 30, FlxUIDropDownMenu.makeStrIdLabelArray(characters, true),
			function(character:String)
			{
		...
		var player3DropDown = new FlxUIDropDownMenu(140, loadAutosaveBtn.y + 60, FlxUIDropDownMenu.makeStrIdLabelArray(characters, true),
			function(character:String)
			{
	...
	function updateGrid():Void
	{
		...
		for (i in _events)
		{
			if (i.strumTime >= sectionStartTime()
