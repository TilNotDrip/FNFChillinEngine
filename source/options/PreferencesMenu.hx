...
import options.AtlasText.AtlasFont;
import options.TextMenuList.TextMenuItem;

class PreferencesMenu extends options.OptionsState.Page
{
	...
	public function new()
	{
		...
		menuCamera = new objects.SwagCamera();
