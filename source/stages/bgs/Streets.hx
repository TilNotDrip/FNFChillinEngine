...
class Streets extends StageBackend
{
	...
	override public function create()
	{
		...
		scrollingSky = new FlxTiledSprite(Paths.content.image('phillyStreets/phillySkybox'), 2922, 718, true, false);
	...
	override public function createPost()
	{
		...
		stereoBG = new FlxSprite(0, 0, Paths.content.image('characters/abot/stereoBG'));
		addBehindGF(stereoBG);

		pupil = new FlxAnimate(0, 0, Paths.location.atlas("characters/abot/systemEyes", 'shared'));
		// pupil.scrollFactor.set();
		addBehindGF(pupil);

		// viz

		abot = new FlxAnimate(0, 0, Paths.location.atlas("characters/abot/abotSystem", 'shared'));
