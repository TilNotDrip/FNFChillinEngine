...
{
    public var dialogueList:Array<DialogueEntry> = [
        {text: 'coolswag', character: 'bf'},
        {text: 'money money', character: 'dad'}
    ];
    ...
    override public function create()
    {
        ...
        background.alpha = 0;
        FlxTween.tween(background, {alpha: 0.8}, 3, {onComplete: function(twn:FlxTween) {
            bubble.visible = true;
            handleDialogue();
        }});
    }
